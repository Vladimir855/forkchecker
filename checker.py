...
def trypricefetch(testfork, balance):
	...
	if type == "yobit":
		for yobitlistingticker, yobitlistinginfo in list(yobitdb.items()):
	...
	if type == "bisq":
		for bisqlistingticker, bisqlistinginfo in list(bisqdb.items()):
	...
	if type == "coinex":
		for coinexticker, coinexlisting in list(coinexdb.items()):
			if cmc == coinexticker:
